...
class GAT(torch.nn.Module):
    ...
    def __init__(self, num_of_layers, num_heads_per_layer, num_features_per_layer, add_skip_connection=True, bias=True,
                 dropout=0.6, log_attention_weights=False, source_feats=None, target_feats=None):
        super().__init__()
    ...
    def forward(self, edge_index, net='s', new_feats=None, A_hat=None):
        ...
        for i in range(self.num_of_layers):
            GAT_output_i = self.gat_layers[i](emb_input, edge_index, A_hat)
...
class GATLayer(torch.nn.Module):
    ...
    def forward(self, in_nodes_features, edge_index, A_hat=None):
        #
        ...
        #     out_nodes_features = torch.sparse.mm(A_hat, out_nodes_features)
    ...
    def sum_edge_scores_neighborhood_aware(self, exp_scores_per_edge, trg_index, num_of_nodes):
        ...
        # target index)
        neighborhood_sums.scatter_add_(self.nodes_dim, trg_index_broadcasted.type(torch.int64), exp_scores_per_edge)
    ...
    def aggregate_neighbors(self, nodes_features_proj_lifted_weighted, edge_index, in_nodes_features, num_of_nodes):
        ...
        out_nodes_features.scatter_add_(self.nodes_dim, trg_index_broadcasted.type(torch.int64), nodes_features_proj_lifted_weighted)
